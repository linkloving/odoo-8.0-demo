...
__icons_list = ['STOCK_ABOUT', 'STOCK_ADD', 'STOCK_APPLY', 'STOCK_BOLD',
                ...
                'terp-stock_align_left_24', 'terp-stock_effects-object-colorize', 'terp-go-home',
                'terp-gtk-go-back-rtl',
                'terp-gtk-go-back-ltr', 'terp-personal', 'terp-personal-', 'terp-personal+',
                ...
                'terp-mail-message-new', 'terp-mail-replied', 'terp-rating-rated', 'terp-stage',
...
def get_win32_timezone():
    ...
    if sys.platform == "win32":
        try:
            ...
            current_tz_key = _winreg.OpenKey(hklm, r"SYSTEM\CurrentControlSet\Control\TimeZoneInformation", 0,
