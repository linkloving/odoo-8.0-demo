...
_default_parameters = {
    ...
    datetime.datetime.now().strftime(misc.DEFAULT_SERVER_DATETIME_FORMAT), ['base.group_user']),
...
class ir_config_parameter(osv.osv):
    ...
    _columns = {
        ...
        'group_ids': fields.many2many('res.groups', 'ir_config_parameter_groups_rel', 'icp_id', 'group_id',
                                      string='Groups'),
    }
