...
class res_partner(osv.Model, format_address):
    ...
    def fields_view_get(self, cr, user, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(res_partner, self).fields_view_get(cr, user, view_id, view_type, context, toolbar=toolbar,
                                                       submenu=submenu)
        if view_type == 'form':
    ...
    def unlink(self, cr, uid, ids, context=None):
        orphan_contact_ids = self.search(cr, uid,
                                         [('parent_id', 'in', ids), ('id', 'not in', ids),
                                          ('use_parent_address', '=', True)], context=context)
    ...
    def _search(self, cr, user, args, offset=0, limit=None, order=None, context=None, count=False,
        ...
        return super(res_partner, self)._search(cr, user, args, offset=offset, limit=limit, order=order,
                                                context=context,
