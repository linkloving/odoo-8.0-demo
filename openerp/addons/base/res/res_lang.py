...
class lang(osv.osv):
    ...
    _columns = {
        ...
        'code': fields.char('Locale Code', size=16, required=True,
                            help='This field is used to set/get locales for user'),
        'iso_code': fields.char('ISO code', size=16, required=False,
        ...
        'grouping': fields.char('Separator Format', required=True,
