...
class _column(object):
    ...
    def __init__(self, string='unknown', required=False, readonly=False, domain=[], context={}, states=None, priority=0,
                 change_default=False, size=None, ondelete=None, translate=False, select=False, manual=False, **args):
        """
    ...
    def set(self, cr, obj, id, name, value, user=None, context=None):
        cr.execute('update ' + obj._table + ' set ' + name + '=' + self._symbol_set[0] + ' where id=%s',
...
class datetime(_column):
    ...
    @classmethod
    def _as_display_name(cls, field, cr, uid, obj, value, context=None):
        value = datetime.context_timestamp(cr, uid, DT.datetime.strptime(value, tools.DEFAULT_SERVER_DATETIME_FORMAT),
                                           context=context)
...
class many2one(_column):
    ...
    def search(self, cr, obj, args, name, value, offset=0, limit=None, uid=None, context=None):
        return obj.pool[self._obj].search(cr, uid, args + self._domain + [('name', 'like', value)], offset, limit,
                                          context=context)
        ...
        with rec.env.norecompute():
            ...
            for act in values:
                if act[0] == 0:
                    ...
                    ids2 = act[2] or [0]
                    cr.execute('select id from ' + _table + ' where ' + self._fields_id + '=%s and id <> ALL (%s)',
                               (id, ids2))
...
class many2many(_column):
    ...
    #
    def search(self, cr, obj, args, name, value, offset=0, limit=None, uid=None, operator='like', context=None):
        return obj.pool[self._obj].search(cr, uid, args + self._domain + [('name', operator, value)], offset, limit,
                                          context=context)
...
class function(_column):
    ...
    def __init__(self, fnct, arg=None, fnct_inv=None, fnct_inv_arg=None, type='float', fnct_search=None, obj=None,
...
class related(function):
    ...
    def __init__(self, *arg, **args):
        self.arg = arg
        self._relations = []
        super(related, self).__init__(self._related_read, arg, self._related_write, fnct_inv_arg=arg,
                                      fnct_search=self._related_search, **args)
    ...
    def _sparse_write(self, obj, cr, uid, ids, field_name, value, args, context=None):
        ...
        for record in records:
            ...
            if value is None:
                ...
                serialized[field_name] = self.convert_value(obj, cr, uid, record, value, serialized.get(field_name),
                                                            context=context)
...
class dummy(function):
    ...
    def __init__(self, *arg, **args):
        self.arg = arg
        self._relations = []
        super(dummy, self).__init__(self._dummy_read, arg, self._dummy_write, fnct_inv_arg=arg,
                                    fnct_search=self._dummy_search, **args)
