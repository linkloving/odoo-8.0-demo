...
class Change(unohelper.Base, XJobExecutor):
    ...
    def btnNext_clicked(self, oActionEvent):
        ...
        # aVal= Fetature used
        try:
            url = self.protocol[self.win.getListBoxSelectedItem("lstProtocol")] + self.win.getEditText(
...
if __name__ <> "package" and __name__ == "__main__":
    ...
    g_ImplementationHelper.addImplementation(Change, "org.openoffice.openerp.report.change",
