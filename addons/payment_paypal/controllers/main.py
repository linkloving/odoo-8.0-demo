...
class PaypalController(http.Controller):
    ...
    def paypal_validate_data(self, **post):
        ...
        paypal_urls = request.registry['payment.acquirer']._get_paypal_urls(cr, uid,
        ...
        if resp == 'VERIFIED':
            ...
            res = request.registry['payment.transaction'].form_feedback(cr, SUPERUSER_ID, post, 'paypal',
                                                                        context=context)
        elif resp == 'INVALID':
