...
class TestResourceCommon(common.TransactionCase):
    def setUp(self):
        ...
        # Some demo data
        self.date1 = datetime.strptime('2013-02-12 09:08:07',
                                       '%Y-%m-%d %H:%M:%S')  # weekday() returns 1, isoweekday() returns 2
        self.date2 = datetime.strptime('2013-02-15 10:11:12',
                                       '%Y-%m-%d %H:%M:%S')  # weekday() returns 4, isoweekday() returns 5
