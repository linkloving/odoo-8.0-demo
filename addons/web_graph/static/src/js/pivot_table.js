...
//  PivotTable requires a call to update_data after initialization
    openerp.web_graph.PivotTable = openerp.web.Class.extend({
        ...
        set: function (domain, row_groupby, col_groupby, measures_groupby) {
            ...
            if (measures_groupby.length) {
                this.measures = measures_groupby;
            }
            ...
            if (measures_gb_changed && measures_groupby.length) {
                this.set_measures(measures_groupby);
            }
        ...
        main_row: function () {
            return this.rows.headers[0];
        },

        main_col: function () {
            return this.cols.headers[0];
        },
        ...
        make_headers_and_cell: function (data_pts, row_headers, col_headers, index, prefix, expand) {
            ...
            data_pts.forEach(function (data_pt) {
                ...
                if (expand && !_.find(col_headers, function (hdr) {
                        return self.isEqual(col_value, hdr.path);
                    })) {
                    return;
                }
        ...
        perform_requests: function (group1, group2, domain) {
            var self = this,
                ...
                fields = field_list.map(function (f) {
