...
class Users(osv.Model):
    ...
    def _get_user_badge_level(self, cr, uid, ids, name, args, context=None):
        ...
        for id in ids:
            result[id] = {
                'gold_badge': badge_user_obj.search(cr, uid, [('badge_id.level', '=', 'gold'), ('user_id', '=', id)],
                                                    context=context, count=True),
                'silver_badge': badge_user_obj.search(cr, uid,
                                                      [('badge_id.level', '=', 'silver'), ('user_id', '=', id)],
                                                      context=context, count=True),
                'bronze_badge': badge_user_obj.search(cr, uid,
                                                      [('badge_id.level', '=', 'bronze'), ('user_id', '=', id)],
                                                      context=context, count=True),
            }
        return result
    ...
    _columns = {
        ...
        'gold_badge': fields.function(_get_user_badge_level, string="Number of gold badges", type='integer',
                                      multi='badge_level'),
        'silver_badge': fields.function(_get_user_badge_level, string="Number of silver badges", type='integer',
                                        multi='badge_level'),
        'bronze_badge': fields.function(_get_user_badge_level, string="Number of bronze badges", type='integer',
                                        multi='badge_level'),
    }
    ...
    def send_forum_validation_email(self, cr, uid, user_id, forum_id=None, context=None):
        ...
        if activation_template_id:
            ...
            self.pool['email.template'].send_mail(cr, SUPERUSER_ID, activation_template_id, user_id, force_send=True,
                                                  context=tpl_ctx)
        return True
    ...
    def get_serialised_gamification_summary(self, cr, uid, excluded_categories=None, context=None):
        ...
        return super(Users, self).get_serialised_gamification_summary(cr, uid, excluded_categories=excluded_categories,
                                                                      context=context)
