...
class event_track(osv.osv):
    ...
    _columns = {
        ...
        'priority': fields.selection([('3', 'Low'), ('2', 'Medium (*)'), ('1', 'High (**)'), ('0', 'Highest (***)')],
...
class event_event(osv.osv):
    ...
    _columns = {
        ...
        'tracks_tag_ids': fields.function(_get_tracks_tag_ids, type='one2many', relation='event.track.tag',
                                          string='Tags of Tracks'),
        'allowed_track_tag_ids': fields.many2many('event.track.tag', string='Accepted Tags',
...
class event_sponsors(osv.osv):
    ...
    def has_access_to_partner(self, cr, uid, ids, context=None):
        ...
        return len(partner_ids) == self.pool.get("res.partner").search(cr, uid, [("id", "in", partner_ids)], count=True,
                                                                       context=context)
