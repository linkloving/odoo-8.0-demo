...
class WebsiteDoc(http.Controller):
    @http.route(['/forum/how-to', '/forum/how-to/<model("forum.documentation.toc"):toc>'], type='http', auth="public",
                website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/question/<model("forum.post"):post>/promote', type='http',
