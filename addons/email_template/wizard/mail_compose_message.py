...
class mail_compose_message(osv.TransientModel):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if res.get('composition_mode') != 'mass_mail' and context.get('default_template_id') and res.get(
                'model') and res.get('res_id'):
            res.update(
    ...
    def send_mail(self, cr, uid, ids, context=None):
        ...
        for wizard in self.browse(cr, uid, ids, context=context):
            if wizard.template_id:
                wizard_context[
                    'mail_notify_user_signature'] = False  # template user_signature is added when generating body_html
                wizard_context[
                    'mail_auto_delete'] = wizard.template_id.auto_delete  # mass mailing: use template auto_delete value -> note, for emails mass mailing only
            ...
            for attachment in wizard.attachment_ids:
                if attachment in wizard.template_id.attachment_ids:
                    new_attachment_ids.append(self.pool.get('ir.attachment').copy(cr, uid, attachment.id,
    ...
    def onchange_template_id(self, cr, uid, ids, template_id, composition_mode, model, res_id, context=None):
        ...
        if template_id and composition_mode == 'mass_mail':
            ...
            default_context = dict(context, default_composition_mode=composition_mode, default_model=model,
    ...
    def generate_email_for_composer_batch(self, cr, uid, template_id, res_ids, context=None, fields=None):
        ...
        template_values = self.pool.get('email.template').generate_email_batch(cr, uid, template_id, res_ids,
