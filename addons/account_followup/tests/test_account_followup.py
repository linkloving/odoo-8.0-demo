...
class TestAccountFollowup(TransactionCase):
    def setUp(self):
        ...
        self.partner_id = self.partner.create(cr, uid, {'name': 'Test Company',
                                              ...
                                              context=None)
        self.followup_id = \
        self.registry("ir.model.data").get_object_reference(cr, uid, "account_followup", "demo_followup1")[1]
        ...
        self.registry("ir.model.data").get_object_reference(cr, uid, "account_followup", "demo_followup_line1")[1]
        self.last_followup_line_id = \
        self.registry("ir.model.data").get_object_reference(cr, uid, "account_followup", "demo_followup_line3")[1]
        self.product_id = self.registry("ir.model.data").get_object_reference(cr, uid, "product", "product_product_6")[
            1]
        ...
        self.current_date = datetime.datetime.strptime(fields.date.context_today(self.user, cr, uid, context={}),
    ...
    def test_06_pay_the_invoice(self):
        ...
        self.assertFalse(self.partner.browse(cr, uid, self.partner_id).payment_next_action_date,
