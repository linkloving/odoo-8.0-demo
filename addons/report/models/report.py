...
class Report(osv.Model):
    ...
    def get_pdf(self, cr, uid, ids, report_name, html=None, data=None, context=None):
        ...
        base_url = irconfig_obj.get_param(cr, SUPERUSER_ID, 'report.url') or irconfig_obj.get_param(cr, SUPERUSER_ID,
                                                                                                    'web.base.url')
    ...
    def _run_wkhtmltopdf(self, cr, uid, headers, footers, bodies, landscape, paperformat, spec_paperformat_args=None,
