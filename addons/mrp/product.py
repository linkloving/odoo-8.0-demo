...
class product_template(osv.osv):
    ...
    _columns = {
        ...
        'bom_count': fields.function(_bom_orders_count, string='# Bill of Material', type='integer',
                                     multi="_bom_order_count"),
        'mo_count': fields.function(_bom_orders_count_mo, string='# Manufacturing Orders', type='integer'),
        'produce_delay': fields.float('Manufacturing Lead Time',
        ...
        'track_production': fields.boolean('Track Manufacturing Lots',
                                           help="Forces to specify a Serial Number for all moves containing this product and generated by a Manufacturing Order"),
    }
...
class product_product(osv.osv):
    ...
    def action_view_bom(self, cr, uid, ids, context=None):
        ...
        result[
            'context'] = "{'default_product_id': active_id, 'search_default_product_id': active_id, 'default_product_tmpl_id': %s}" % (
