...
class report_webkit_actions(osv.osv_memory):
    ...
    _columns = {
        'print_button': fields.boolean('Add print button',
                                       help="Check this to add a Print action for this Report in the sidebar of the corresponding document types"),
        'open_action': fields.boolean('Open added action',
                                      help="Check this to view the newly added internal print action after creating it (technical view) "),
    }
    _defaults = {
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(report_webkit_actions, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type,
